...
function show()
{
	...
	for(var i=0; i < array.length; i++)							//Create a For Loop to display the Array
	{
		...
		htmlFormat += "<li>" + (i + 1) + ")&nbsp;&emsp;" + array[i] + " <button class='ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all remove' id='" + i + "'>delete</button></li>";		//Create a button tag using a class and unique id
	}
